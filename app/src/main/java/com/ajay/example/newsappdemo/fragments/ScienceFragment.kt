...
class ScienceFragment : Fragment(), RecyclerItemClickListener.OnRecyclerClickListner {

    private lateinit var binding: FragmentScienceBinding
    private val adapter = ScienceAdapter()
    ...
    override fun onCreateView(
        ...
        viewModel = ViewModelProvider(
            this,
            ScienceViewModelFactory(newsRepository)
