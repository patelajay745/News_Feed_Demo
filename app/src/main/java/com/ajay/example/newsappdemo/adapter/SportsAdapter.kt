...
class SportsAdapter : RecyclerView.Adapter<MySportsViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MySportsViewHolder {
        ...
        return MySportsViewHolder(binding)
    }
...
class MySportsViewHolder(val binding: NewsItemBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    fun bind(news: Article) {
        ...
        binding.title.setBackgroundColor(Color.parseColor("#795548"))
