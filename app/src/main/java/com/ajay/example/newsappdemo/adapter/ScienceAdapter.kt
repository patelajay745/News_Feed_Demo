...
class ScienceAdapter : RecyclerView.Adapter<MyScienceViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyScienceViewHolder {
        val binding = NewsItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return MyScienceViewHolder(binding)
    }

    override fun onBindViewHolder(holder: MyScienceViewHolder, position: Int) {
...
class MyScienceViewHolder(val binding: NewsItemBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    fun bind(news: Article) {
        ...
        binding.title.setBackgroundColor(Color.parseColor("#3F51B5"))
